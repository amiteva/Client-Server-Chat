...
public class ChatClient extends Thread
{
	...
	public ChatClient() throws Exception {
		...
		System.out.println("Enter a username [the username must be your first name followed by your student identification number. It can not start with a '@', and it can not contain any spaces !!]:");
		...
		try {
			...
			socket = new Socket("localhost", serverPort); // create socket connection (socket of the server that we connect to)
